...
var jsonSchema = require('@metorial/json-schema');
...
var MetorialMcpClient = class _MetorialMcpClient {
  ...
  static async create(session, opts) {
    var _a, _b;
    let client = new index_js.Client({
    ...
    let transport = new sse_js.SSEClientTransport(
      new URL(
  ...
  callTool(params, resultSchema = types_js.CallToolResultSchema, options) {
...
var _MetorialMcpTool = class _MetorialMcpTool {
  ...
  getParametersAs(as = "json-schema") {
    ...
    if (as == "openapi-3.0.0" || as == "openapi-3.1.0") {
      return jsonSchema.jsonSchemaToOpenApi(__privateGet(this, _parameters), {
...
exports.MetorialMcpClient = MetorialMcpClient;
exports.MetorialMcpSession = MetorialMcpSession;
